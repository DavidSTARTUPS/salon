...
function CarouselNavigation({
  ...
  return (
    <div
      className={cn(
        'pointer-events-none absolute left-[-12.5%] top-1/2 flex w-[125%] -translate-y-1/2 justify-between px-2 z-20',
        className
      )}
    >
      <button
        ...
        className={cn(
          'pointer-events-auto h-fit w-fit transition-all duration-300',
          alwaysShow
            ? 'opacity-100'
      ...
      >
        <ChevronLeft
          className='stroke-inherit h-full w-full'
        />
      </button>
      <button
        type='button'
